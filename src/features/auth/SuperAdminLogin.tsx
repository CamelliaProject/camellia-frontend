...
export default function SuperAdminLogin() {
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    signIn({ username, email: `${username}@camellia.com`, role: 'superadmin', token: undefined });
  ...
  return (
    <div className="min-h-screen bg-[#F5F7F5] flex items-center justify-center px-4 py-10">
      <div className="w-full max-w-md bg-white rounded-3xl shadow-xl p-10">
        <h1 className="text-3xl font-bold text-[#1B4332] mb-4">Super Admin Login</h1>
        <p className="text-gray-600 mb-8">Use this portal to approve plantation registrations and manage the platform.</p>
